...
exports.author_update_post = function(req, res, next) {
    var author = new Author({
        _id: req.params.id,// <<<--- NOTESE que el id se obtiene de req.params y no de req.body, esto es por que el id viene en el get y lo demas por post
        first_name: req.body.first_name,
        family_name: req.body.family_name,
        date_of_birth: req.body.date_of_birth,
        date_of_death: req.body.date_of_death
    });
    Author.findByIdAndUpdate(req.params.id, author, {}, function(error, authorUpdated){
        if (error) {
            return next();
        }
